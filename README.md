...
<p align="center">
  <a href="https://github.com/956zs/vrc-asset-manager/releases">
    <img alt="Release" src="https://img.shields.io/badge/release-0.2.0--beta.3-0ea5e9?style=flat-square" />
  </a>
...
```powershell
npm run version:bump -- 0.2.0-beta.3
npm run release:check -- -Tag v0.2.0-beta.3
npm run release:local -- -Tag v0.2.0-beta.3
```
...
1. 執行 `npm run version:bump -- 0.2.0-beta.3` 同步版本。

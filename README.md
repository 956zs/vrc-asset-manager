...
<p align="center">
  <a href="https://github.com/956zs/vrc-asset-manager/releases">
    <img alt="Release" src="https://img.shields.io/badge/release-0.1.0--beta.9-0ea5e9?style=flat-square" />
  </a>
...
```powershell
npm run version:bump -- 0.1.0-beta.9
npm run release:check -- -Tag v0.1.0-beta.9
npm run release:local -- -Tag v0.1.0-beta.9
```
...
1. 執行 `npm run version:bump -- 0.1.0-beta.9` 同步版本。

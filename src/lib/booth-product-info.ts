...
const modelAliasGroups: readonly ModelAliasGroup[] = [
  {
    ...
    displayName: "桔梗",
    label: "桔梗 / Kikyo",
    aliases: ["桔梗", "桔梗ちゃん", "Kikyo"],
  },
  {
    name: "Shinano",
    displayName: "しなの",
    label: "しなの / Shinano",
    aliases: ["しなの", "しなのちゃん", "信濃", "シナノ", "Shinano"],
  },
  {
    name: "Manuka",
    displayName: "マヌカ",
    label: "マヌカ / Manuka",
    aliases: ["マヌカ", "まぬか", "Manuka", "Manukaマヌカ"],
  },
  {
    name: "Shinra",
    displayName: "森羅",
    label: "森羅 / Shinra",
    aliases: ["森羅", "森羅ちゃん", "Shinra"],
  },
  {
    name: "Sio",
    displayName: "しお",
    label: "しお / Sio",
    aliases: ["しお", "しおちゃん", "Sio"],
  },
...
const boothTagMappings: readonly {
  ...
  {
    localName: "髮型",
    aliases: ["Hair", "Hairstyle", "Hair Style", "髪型", "髮型", "ヘア"],
  },
  {
    localName: "配件",
    aliases: [
